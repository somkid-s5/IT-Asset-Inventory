...
export const VM_INVENTORY_RECORDS: VmInventoryDetail[] = [
  {
    ...
    slaTier: 'Tier 2',
    description: 'Primary API runtime with manual business context managed in AssetOps.',
    tags: ['api', 'linux', 'runtime'],
    lastSyncAt: '10 min ago',
    syncedFields: ['VM Name', 'MoID', 'Power State', 'Cluster', 'Host', 'Guest OS', 'Primary IP', 'vCenter Tags'],
    managedFields: ['Owner', 'Environment', 'Business Unit', 'SLA Tier', 'Description', 'Custom Notes'],
  ...
  },
  {
    ...
    slaTier: 'Tier 3',
    description: 'Test VM with a clean guest account set and a manually managed owner context.',
    tags: ['web', 'iis', 'qa'],
    lastSyncAt: '4 min ago',
    syncedFields: ['VM Name', 'MoID', 'Power State', 'Cluster', 'Host', 'Guest OS', 'Primary IP', 'vCenter Tags'],
    managedFields: ['Owner', 'Environment', 'Business Unit', 'SLA Tier', 'Description', 'Custom Notes'],
...
export const VM_DISCOVERY_QUEUE: VmDiscoveryItem[] = [
  {
    ...
    state: 'NEEDS_CONTEXT',
    completeness: 58,
    missingFields: ['Owner', 'Business Unit', 'SLA Tier', 'Description'],
    lastSeen: '3 min ago',
    tags: ['batch', 'linux'],
    guestAccountsCount: 2,
    suggestedOwner: null,
  ...
  },
  {
    ...
    state: 'DRIFTED',
    completeness: 45,
    missingFields: ['Owner', 'Environment', 'SLA Tier', 'Description', 'Guest Accounts'],
